...
> **Setup note (remove before publishing):** This post uses LaTeX-style equations (`$$...$$`). For these to render as real math on GitHub Pages, add MathJax to your site layout's `<head>` once:
>
> ```html
> <script>
...
> ```
>
> Once it's in your layout, it applies site-wide to every post.
